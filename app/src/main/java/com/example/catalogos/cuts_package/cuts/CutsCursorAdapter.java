 ...
 */
public class CutsCursorAdapter extends CursorAdapter {
    public CutsCursorAdapter(Context context, Cursor c) {
        super(context, c, 0);
    }
    ...
    public void bindView(View view, final Context context, Cursor cursor) {
        ...
        // Get valores.
        String entryName =  CutEntry.NAME;
        String entryAvatar =  CutEntry.AVATAR_URI;
        int i = cursor.getColumnIndex(entryName);
        String name = cursor.getString(i);
        i = cursor.getColumnIndex(entryAvatar);
        String avatarUri = cursor.getString(i);
//        String avatarUri = cursor.getString(cursor.getColumnIndex(CutEntry.AVATAR_URI));
