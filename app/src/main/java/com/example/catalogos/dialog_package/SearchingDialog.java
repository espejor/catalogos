...
public class SearchingDialog extends Dialog {
    ...
    public SearchingDialog(@NonNull Context context, CursorAdapter adapter,
    ...
    public void swapCursor(){
        cursorAdapter.swapCursor (dbHelper.getAllData (tableToSearch,fieldToSearch));
    }
}
