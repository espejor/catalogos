...
/**
 * Adaptador de Tipo de Joyas
 */
public class JewelTypesCursorAdapter extends CursorAdapter {
    public JewelTypesCursorAdapter(Context context, Cursor c) {
        super(context, c, 0);
    }
    ...
    public void bindView(View view, final Context context, Cursor cursor) {
        ...
        // Get valores.
        String entryName =  JewelTypeEntry.NAME;
        String entryAvatar =  JewelTypeEntry.AVATAR_URI;
        int i = cursor.getColumnIndex(entryName);
        String name = cursor.getString(i);
        i = cursor.getColumnIndex(entryAvatar);
        String avatarUri = cursor.getString(i);
//        String avatarUri = cursor.getString(cursor.getColumnIndex(JewelTypeEntry.AVATAR_URI));
