 ...
 */
public class OwnersCursorAdapter extends CursorAdapter {
    boolean multiSelector = false;
    public OwnersCursorAdapter(Context context, Cursor c) {
        super(context, c, 0);
    }
    ...
    public void bindView(View view, final Context context, Cursor cursor) {
        ...
        // Get valores.
        String entryName =  OwnerEntry.NAME;
        String entryAvatar =  OwnerEntry.AVATAR_URI;
...
//        String avatarUri = cursor.getString(cursor.getColumnIndex(OwnerEntry.AVATAR_URI));
